...
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4">Configuración de Clientes</h1>
    <table class="min-w-full bg-white">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="py-2">
                    <a href="{{ route('admin.client-settings.edit', $setting) }}" class="bg-yellow-500 text-white py-1 px-2 rounded">Editar</a>
                </td>
            </tr>
            @endforeach
        </tbody>
