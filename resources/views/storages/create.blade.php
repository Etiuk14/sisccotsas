...
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4">Crear Almacenamiento Adicional</h1>
    <form action="{{ route('admin.storages.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="number" id="storage_limit" name="storage_limit" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        </div>
